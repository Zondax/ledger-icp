...
const TEST_CASES = [
  {
    ...
    principal: 'wcrs6-xaqh2-777q4-d2fy5-mftua-yneth-crwql-4ctbg-bsnq3-usujm-hae',
  ...
  },
  {
    ...
    principal: 'ca4dg-cmzb5-iqs7q-5mjmv-opljf-l7xup-yd75d-npqel-rgsgf-dglzt-yae',
  ...
  },
  {
    ...
    principal: 'ebrm6-pnhgu-mdv6c-hcoyf-2w4sd-orpqw-m5mxs-lfifv-iunaf-me3s2-cae',
  ...
  },
  {
    ...
    principal: 'zr3yz-g22dq-ehyjt-df2gr-c5b3b-ohxkv-gs2nf-3vxxs-bgnta-5a7h3-uae',
  ...
  test.each(DEVICE_MODELS)('get address with seed', async function (m) {
    ...
    for (const TEST of TEST_CASES) {
      ...
      try {
        ...
        expect(resp.principalText).toEqual(TEST.principal)

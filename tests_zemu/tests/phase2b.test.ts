...
describe('Phase2', function () {
  ...
  test.each(DEVICE_MODELS)('sign normal -- merge', async function (m) {
    ...
    try {
      ...
      await sim.compareSnapshotsAndAccept('.', `${m.prefix.toLowerCase()}-sign_merge`, m.name === 'nanos' ? 3 : 4)
  ...
  test.each(DEVICE_MODELS)('sign normal -- dissolve delay', async function (m) {
    const sim = new Zemu(m.path)
    try {
      await sim.start({ ...DEFAULT_OPTIONS, model: m.name })
      const app = new InternetComputerApp(sim.getTransport())
      ...
      const txBlobStr =
        ''
      const txBlob = Buffer.from(txBlobStr, 'hex')
      ...
      await sim.compareSnapshotsAndAccept('.', `${m.prefix.toLowerCase()}-sign_dissolvedelay`, m.name === 'nanos' ? 3 : 4)

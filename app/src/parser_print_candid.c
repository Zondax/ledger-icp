...
__Z_INLINE parser_error_t print_permission(int32_t permission, char *outVal,
  ...
  case NEURON_PERMISSION_TYPE_CONFIGURE_DISSOLVE_STATE:
    pageString(outVal, outValLen, "Configure Dissolve State", pageIdx,
               pageCount);
    break;
  ...
  case NEURON_PERMISSION_TYPE_MANAGE_VOTING_PERMISSION:
    pageString(outVal, outValLen, "Manage Voting Permission", pageIdx,
               pageCount);
    break;
...
__Z_INLINE parser_error_t print_follow_topic(int32_t topic, char *outVal,
                                             uint16_t outValLen,
                                             uint8_t pageIdx,
                                             uint8_t *pageCount) {
  switch (topic) {
  ...
  case FOLLOW_TOPIC_NETWORK_CANISTER_MANAGEMENT:
    pageString(outVal, outValLen, "Network Canister Management", pageIdx,
               pageCount);
    break;
  ...
  case FOLLOW_TOPIC_SNS_DECENTRALIZATION_SALE:
    pageString(outVal, outValLen, "SNS Decentralization Swap", pageIdx,
               pageCount);
    break;
  case FOLLOW_TOPIC_SUBNET_REPLICA_VERSION_MANAGEMENT:
    pageString(outVal, outValLen, "Subnet Replica Version Management", pageIdx,
               pageCount);
    break;
  case FOLLOW_TOPIC_REPLICA_VERSION_MANAGEMENT:
    pageString(outVal, outValLen, "Replica Version Management", pageIdx,
               pageCount);
    break;
...
static parser_error_t parser_getItemSetDissolveTimestamp(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;

  const candid_ManageNeuron_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_manageNeuron;
  PARSER_ASSERT_OR_ERROR(fields->command.hash == hash_command_Configure,
                         parser_unexpected_value)
  PARSER_ASSERT_OR_ERROR(fields->command.configure.has_operation,
                         parser_unexpected_value)
  PARSER_ASSERT_OR_ERROR(fields->command.configure.operation.hash ==
                             hash_operation_SetDissolvedTimestamp,
                         parser_unexpected_value)
  ...
  if (displayIdx == 1) {
    ...
    if (fields->has_neuron_id_or_subaccount &&
        fields->neuron_id_or_subaccount.which == 1) {
      return print_u64(fields->neuron_id_or_subaccount.neuronId.id, outVal,
                       outValLen, pageIdx, pageCount);
    }
  ...
  if (displayIdx == 2) {
    ...
    uint64_t dissolve_timestamp_seconds =
        fields->command.configure.operation.setDissolveTimestamp
    ...
    snprintf(tmpBuffer, sizeof(tmpBuffer), "%04d-%02d-%02d %02d:%02d:%02d UTC",
             td.tm_year, td.tm_mon, td.tm_day, td.tm_hour, td.tm_min,
             td.tm_sec);
...
static parser_error_t parser_getItemChangeAutoStakeMaturity(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  PARSER_ASSERT_OR_ERROR(fields->command.configure.has_operation,
                         parser_unexpected_value)
  PARSER_ASSERT_OR_ERROR(fields->command.configure.operation.hash ==
                             hash_operation_ChangeAutoStakeMaturity,
                         parser_unexpected_value)

  if (displayIdx == 0) {
    snprintf(outKey, outKeyLen, "Transaction type");
    pageString(outVal, outValLen, "Set Auto Stake Maturity", pageIdx,
               pageCount);
    return parser_ok;
  }
  ...
  if (displayIdx == 2) {
    ...
    snprintf(outVal, outValLen,
             fields->command.configure.operation.autoStakeMaturity
...
static parser_error_t parser_getItemDisburseCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  if (displayIdx == 2) {
    ...
    if (fields->command.disburse.has_account_identifier) {
      return page_hexstring_with_delimiters(
          fields->command.disburse.account_identifier.p,
...
static parser_error_t parser_getItemRegisterVoteCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  if (displayIdx == 2) {
    ...
    return print_u64(fields->command.vote.proposal.id, outVal, outValLen,
                     pageIdx, pageCount);
  }
...
parser_getItemFollowCandid(uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
  ...
  *pageCount = 1;
  ...
  if (displayIdx == 2) {
    ...
    return print_follow_topic(fields->command.follow.topic, outVal, outValLen,
                              pageIdx, pageCount);
  }
  ...
  if (displayIdx <= fields->command.follow.followees_size) {
    snprintf(outKey, outKeyLen, "Followees (%d/%d) ", displayIdx,
             fields->command.follow.followees_size);
    uint64_t followee = 0;
    CHECK_PARSER_ERR(
        getCandidNat64FromVec(fields->command.follow.followees_ptr, &followee,
                              fields->command.follow.followees_size,
...
static parser_error_t parser_getItemIncreaseDissolveDelayCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  PARSER_ASSERT_OR_ERROR(fields->command.configure.has_operation,
                         parser_unexpected_value)
  PARSER_ASSERT_OR_ERROR(fields->command.configure.operation.hash ==
                             hash_operation_IncreaseDissolveDelay,
                         parser_unexpected_value)
  ...
  if (displayIdx == 2) {
    ...
    if (fields->command.configure.operation.increaseDissolveDelay
            .dissolve_timestamp_seconds == 0) {
    ...
    uint64_t value = 0;
    MEMCPY(&value,
           &fields->command.configure.operation.increaseDissolveDelay
                .dissolve_timestamp_seconds,
           4);
...
static parser_error_t parser_getItemConfigureAddRemoveHotkeyCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const uint64_t hash = parser_tx_obj.tx_fields.call.data.candid_manageNeuron
                            .command.configure.operation.hash;
  const candid_ManageNeuron_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_manageNeuron;
  ...
  if (displayIdx == 2) {
    ...
    return print_principal(
        fields->command.configure.operation.hotkey.principal.ptr,
        fields->command.configure.operation.hotkey.principal.len, outVal,
        outValLen, pageIdx, pageCount);
  }
...
static parser_error_t
parser_getItemSpawnCandid(uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
                          char *outVal, uint16_t outValLen, uint8_t pageIdx,
                          uint8_t *pageCount) {
  *pageCount = 1;
  ...
  const uint8_t has_percentage_to_spawn =
      fields->command.spawn.has_percentage_to_spawn;
  ...
  if (displayIdx == 2 && has_percentage_to_spawn) {
    ...
    snprintf(outVal, outValLen, "%d",
             fields->command.spawn.percentage_to_spawn);
    return parser_ok;
  }
  ...
  if ((displayIdx == 2 && !has_percentage_to_spawn) ||
    ...
    return print_principal(fields->command.spawn.new_controller.ptr,
                           fields->command.spawn.new_controller.len, outVal,
                           outValLen, pageIdx, pageCount);
  }
  ...
  if (fields->command.spawn.has_nonce &&
    ...
    return print_u64(fields->command.spawn.nonce, outVal, outValLen, pageIdx,
                     pageCount);
  }
...
static parser_error_t parser_getItemStakeMaturityCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  const uint8_t has_percentage_to_stake =
      fields->command.stake.has_percentage_to_stake;
  ...
  if (displayIdx == 2 && has_percentage_to_stake) {
    ...
    snprintf(outVal, outValLen, "%d",
             fields->command.stake.percentage_to_stake);
    return parser_ok;
  }
  return parser_no_data;
}

static parser_error_t parser_getItemSplit(uint8_t displayIdx, char *outKey,
  ...
  *pageCount = 1;
  ...
  const candid_ManageNeuron_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_manageNeuron;
  PARSER_ASSERT_OR_ERROR(fields->command.hash == hash_command_Split,
                         parser_unexpected_value)
...
static parser_error_t parser_getItemMerge(uint8_t displayIdx, char *outKey,
                                          uint16_t outKeyLen, char *outVal,
                                          uint16_t outValLen, uint8_t pageIdx,
                                          uint8_t *pageCount) {
  *pageCount = 1;
  ...
  const candid_ManageNeuron_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_manageNeuron;
  PARSER_ASSERT_OR_ERROR(fields->command.hash == hash_command_Merge,
                         parser_unexpected_value)
  ...
  if (displayIdx == 1) {
    ...
    snprintf(outKey, outKeyLen, "Neuron ID");
    return print_u64(fields->command.merge.source.id, outVal, outValLen,
                     pageIdx, pageCount);
  }
...
static parser_error_t parser_getItemListNeuronsCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const candid_ListNeurons_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_listNeurons;
  ...
  if (displayIdx <= fields->neuron_ids_size) {
    ...
    CHECK_PARSER_ERR(getCandidNat64FromVec(fields->neuron_ids_ptr, &neuron_id,
                                           fields->neuron_ids_size,
                                           displayIdx - 1))
...
static parser_error_t parser_getItemListUpdateNodeProvider(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;

  const candid_UpdateNodeProvider_t *fields =
      &parser_tx_obj.tx_fields.call.data.candid_updateNodeProvider;

  if (displayIdx == 0) {
    snprintf(outKey, outKeyLen, "Transaction type");
    pageString(outVal, outValLen, "Set Node Provider : Reward Account", pageIdx,
               pageCount);
    return parser_ok;
  }
  ...
  if (displayIdx == 1) {
    ...
    return page_hexstring_with_delimiters(
        fields->account_identifier.p, fields->account_identifier.len, outVal,
        outValLen, pageIdx, pageCount);
  }
...
static parser_error_t parser_getItemConfigureNoElementsCandid(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const uint64_t hash = parser_tx_obj.tx_fields.call.data.candid_manageNeuron
...
static parser_error_t parser_getItemConfigureDissolvingSNS(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const candid_Command_t *command =
      &parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command;
  ...
  if (displayIdx == 0) {
    ...
    if (command->configure.operation.hash == hash_operation_StartDissolving) {
      pageString(outVal, outValLen, "Start Dissolving", pageIdx, pageCount);
    } else if (command->configure.operation.hash ==
               hash_operation_StopDissolving) {
      pageString(outVal, outValLen, "Stop Dissolving", pageIdx, pageCount);
    } else {
      return parser_unexpected_value;
    }
  ...
  if (displayIdx == 1) {
    const uint8_t *canisterId =
        (const uint8_t *)parser_tx_obj.tx_fields.call.canister_id.data;
    const uint8_t canisterIdSize =
        (uint8_t)parser_tx_obj.tx_fields.call.canister_id.len;

    snprintf(outKey, outKeyLen, "Canister Id");
    return print_principal(canisterId, canisterIdSize, outVal, outValLen,
                           pageIdx, pageCount);
  }
  ...
  if (displayIdx == 2) {
    snprintf(outKey, outKeyLen, "Neuron Id ");
    return page_hexstring_with_delimiters(
        parser_tx_obj.tx_fields.call.data.sns_manageNeuron.subaccount.p,
...
static parser_error_t parser_getItemNeuronPermissions(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const sns_NeuronPermissions_t *fields =
      &parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command
           .neuronPermissions;
  const candid_Command_t *command =
      &parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command;
  ...
  if (displayIdx == 3 && fields->has_principal) {
    ...
    return print_principal(fields->principal.ptr, fields->principal.len, outVal,
                           outValLen, pageIdx, pageCount);
  }

  displayIdx -= fields->has_principal ? 4 : 3;
  if (displayIdx < fields->permissionList.list_size ||
      (!fields->has_permissionList && displayIdx == 0)) {
    if (command->hash == sns_hash_command_AddNeuronPermissions) {
    ...
    CHECK_PARSER_ERR(getCandidInt32FromVec(
        fields->permissionList.permissions_list_ptr, &permission,
...
static parser_error_t parser_getItemCandidTransfer(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  ...
  *pageCount = 1;
  ...
  if (app_mode_expert()) {
    if (displayIdx == 1) {
      ...
      return print_principal(fields->sender.data, (uint16_t)fields->sender.len,
                             outVal, outValLen, pageIdx, pageCount);
    }
    ...
    if (displayIdx == 2) {
      ...
      if (fields->data.candid_transfer.has_from_subaccount) {
        return page_hexstring_with_delimiters(
            fields->data.candid_transfer.from_subaccount.p,
...
// due to the device's limited screen space.
  ...
  if (displayIdx == 3) {
    ...
    return print_Amount(fields->data.candid_transfer.amount, outVal, outValLen,
                        pageIdx, pageCount, decimals);
  }
  ...
  if (displayIdx == 5) {
    ...
    return print_u64(fields->data.candid_transfer.memo, outVal, outValLen,
                     pageIdx, pageCount);
  }
...
static parser_error_t
parser_getItemICRCTransfer(uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
                           char *outVal, uint16_t outValLen, uint8_t pageIdx,
                           uint8_t *pageCount) {
  *pageCount = 1;
  ...
  if (displayIdx == 1) {
    ...
    return print_principal(canisterId, canisterIdLen, outVal, outValLen,
                           pageIdx, pageCount);
  }
...
// due to the device's limited screen space.
    ...
    const uint16_t fromSubaccountLen =
        (uint16_t)call->data.icrcTransfer.from_subaccount.len;

    return page_principal_with_subaccount(sender, senderLen, fromSubaccount,
                                          fromSubaccountLen, outVal, outValLen,
                                          pageIdx, pageCount);
  }
...
// due to the device's limited screen space.
    ...
    const uint16_t subaccountLen =
        (uint16_t)call->data.icrcTransfer.account.subaccount.len;

    return page_principal_with_subaccount(owner->ptr, owner->len, subaccount,
                                          subaccountLen, outVal, outValLen,
                                          pageIdx, pageCount);
  }
  ...
  if (displayIdx == 4) {
    ...
    return print_Amount(call->data.icrcTransfer.amount, outVal, outValLen,
                        pageIdx, pageCount, decimals);
  }
  ...
  if (displayIdx == 6) {
    ...
    if (call->data.icrcTransfer.has_memo &&
        call->data.icrcTransfer.memo.len != 0) {
      uint64_t memo = 0;
...
parser_getItemICRC2Approve(uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
  ...
  *pageCount = 1;
  ...
  if (displayIdx == 2) {
    ...
    const uint16_t fromSubaccountLen =
        (uint16_t)call->data.icrc2_approve.from_subaccount.len;
  ...
  if (displayIdx == 3) {
    ...
    const uint16_t subaccountLen =
        (uint16_t)call->data.icrc2_approve.spender.subaccount.len;
  ...
  if (displayIdx == 4) {
    ...
    return print_Amount(call->data.icrc2_approve.amount, outVal, outValLen,
                        pageIdx, pageCount, decimals);
  }

  // Skip fee if not present and not icp canister id
  if (!(call->data.icrc2_approve.has_fee || icp_canisterId))
    displayIdx++;
  ...
  if (displayIdx == 5) {
    ...
    snprintf(outKey, outKeyLen, "%s", title);
    uint64_t fees = call->data.icrc2_approve.has_fee
                        ? call->data.icrc2_approve.fee
                        : DEFAULT_MAXIMUM_FEES;
    return print_Amount(fees, outVal, outValLen, pageIdx, pageCount, decimals);
  }
  ...
  if (displayIdx == 6) {
    snprintf(outKey, outKeyLen, "Memo");
    if (call->data.icrc2_approve.has_memo &&
        call->data.icrc2_approve.memo.len != 0) {
      uint64_t memo = 0;
      // we already checked that len is, at max, 8
...
static parser_error_t
parser_getItemDisburseSNS(uint8_t displayIdx, char *outKey, uint16_t outKeyLen,
                          char *outVal, uint16_t outValLen, uint8_t pageIdx,
                          uint8_t *pageCount) {
  *pageCount = 1;
  const sns_Disburse_t *fields =
      &parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command.sns_disburse;
  ...
  if (displayIdx == 1) {
    const uint8_t *canisterId =
        (uint8_t *)&parser_tx_obj.tx_fields.call.canister_id.data;
    const uint8_t canisterIdSize =
        (uint8_t)parser_tx_obj.tx_fields.call.canister_id.len;
  ...
  if (displayIdx == 3) {
    ...
    if (!fields->has_account) {
      return print_principal(parser_tx_obj.tx_fields.call.sender.data,
                             DFINITY_PRINCIPAL_LEN, outVal, outValLen, pageIdx,
                             pageCount);
    }
    // assume has_account
    ...
    if (fields->account.has_subaccount) {
      return page_principal_with_subaccount(
          principal, principalLen, fields->account.subaccount.p,
          (uint16_t)fields->account.subaccount.len, outVal, outValLen, pageIdx,
          pageCount);
    } else {
      return print_principal(principal, DFINITY_PRINCIPAL_LEN, outVal,
                             outValLen, pageIdx, pageCount);
    }
  }
  if (displayIdx == 4) {
...
static parser_error_t parser_getItemSNSStakeMaturity(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const candid_StakeMaturity_t *fields =
      &parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command.stake;
...
static parser_error_t parser_getItemSNSSetDissolveDelay(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  ...
  if (displayIdx == 3) {
    snprintf(outKey, outKeyLen, "Dissolve Time");
    uint64_t dissolve_timestamp_seconds =
        parser_tx_obj.tx_fields.call.data.sns_manageNeuron.command.configure
...
static parser_error_t parser_getItemRefreshNeuronVotingPower(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;
  const candid_ManageNeuron_t *fields =
  ...
  if (displayIdx == 0) {
    snprintf(outKey, outKeyLen, "Transaction type");
    pageString(outVal, outValLen, "Refresh Neuron Voting Power", pageIdx,
               pageCount);
    return parser_ok;
  }
  if (displayIdx == 1) {
...
static parser_error_t parser_getItemSetNeuronVisibility(
    uint8_t displayIdx, char *outKey, uint16_t outKeyLen, char *outVal,
    uint16_t outValLen, uint8_t pageIdx, uint8_t *pageCount) {
  *pageCount = 1;

  const candid_SetVisibility_t *neuron_visibility =
      &parser_tx_obj.tx_fields.call.data.candid_manageNeuron.command.configure
  ...
  if (neuron_visibility->has_visibility &&
      (neuron_visibility->visibility < 1 ||
       neuron_visibility->visibility > 2)) {
    return parser_unexpected_value;
  }
  ...
  if (displayIdx == 0) {
    ...
    snprintf(outVal, outValLen, "%s",
             neuron_visibility->visibility == 2 ? "Make Neuron Public"
                                                : "Make Neuron Private");
...
__Z_INLINE parser_error_t parser_getItemManageNeuron(
  ...
  *pageCount = 1;
  ...
  case Configure_SetDissolvedTimestamp: {
    return parser_getItemSetDissolveTimestamp(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  case Configure_ChangeAutoStakeMaturity: {
    return parser_getItemChangeAutoStakeMaturity(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  case SpawnCandid: {
    return parser_getItemSpawnCandid(displayIdx, outKey, outKeyLen, outVal,
                                     outValLen, pageIdx, pageCount);
  }
  case Split: {
    return parser_getItemSplit(displayIdx, outKey, outKeyLen, outVal, outValLen,
                               pageIdx, pageCount);
  }
  case Merge: {
    return parser_getItemMerge(displayIdx, outKey, outKeyLen, outVal, outValLen,
                               pageIdx, pageCount);
  }
  case StakeMaturityCandid: {
    return parser_getItemStakeMaturityCandid(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  case DisburseCandid:
    return parser_getItemDisburseCandid(displayIdx, outKey, outKeyLen, outVal,
                                        outValLen, pageIdx, pageCount);
  case RegisterVoteCandid:
    return parser_getItemRegisterVoteCandid(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  case FollowCandid:
    return parser_getItemFollowCandid(displayIdx, outKey, outKeyLen, outVal,
                                      outValLen, pageIdx, pageCount);
  case Configure_IncreaseDissolveDelayCandid: {
    return parser_getItemIncreaseDissolveDelayCandid(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  case Configure_AddHotkeyCandid:
  case Configure_RemoveHotkeyCandid:
    return parser_getItemConfigureAddRemoveHotkeyCandid(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  ...
  case Configure_SetVisibility:
    return parser_getItemSetNeuronVisibility(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  ...
  case SNS_RemoveNeuronPermissions: {
    return parser_getItemNeuronPermissions(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  case SNS_Disburse:
    return parser_getItemDisburseSNS(displayIdx, outKey, outKeyLen, outVal,
                                     outValLen, pageIdx, pageCount);
  case SNS_StakeMaturity:
    return parser_getItemSNSStakeMaturity(displayIdx, outKey, outKeyLen, outVal,
                                          outValLen, pageIdx, pageCount);
  case SNS_Configure_SetDissolveDelay:
    return parser_getItemSNSSetDissolveDelay(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  case NNS_RefreshVotingPower:
    return parser_getItemRefreshNeuronVotingPower(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
...
parser_error_t parser_getItemCandid(const parser_context_t *ctx,
  ...
  *pageCount = 1;
  ...
  case candid_manageneuron: {
    return parser_getItemManageNeuron(ctx, displayIdx, outKey, outKeyLen,
                                      outVal, outValLen, pageIdx, pageCount);
  }

  case candid_updatenodeprovider: {
    return parser_getItemListUpdateNodeProvider(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }

  case candid_listneurons: {
    return parser_getItemListNeuronsCandid(
        displayIdx, outKey, outKeyLen, outVal, outValLen, pageIdx, pageCount);
  }
  ...
  case candid_icrc2_approve:
    return parser_getItemICRC2Approve(displayIdx, outKey, outKeyLen, outVal,
                                      outValLen, pageIdx, pageCount);

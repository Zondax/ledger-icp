...
TEST(TxTest, one_byte_accountid) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a6636172674c620210011a0612040a0211116b63616e6973"
        "7465725f69644a000000000000000101016e696e67726573735f6578706972791b16a2cd"
        "02c5b2d1006b6d6574686f645f6e616d65706d616e6167655f6e6575726f6e5f70626c72"
        "6571756573745f747970656463616c6c6673656e646572581d8a4aa4ffc7bc5ccdcd5a7a"
        "3d10c9bb06741063b02c7e908a624f721d02";
...
TEST(NANOPBTEST, registerVote) {
    uint8_t inBuffer[1000];
    const char *tmp = "620310C8033A060A02087B1001";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(NANOPBTEST, follow) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "6202107B2A3C120210011202100212021003120210041202100512021006120210071202"
        "1008120210091202100A1202100B1202100C1202100D1202100E1202100F";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
    ...
    EXPECT_EQ(request.which_command, 5);
    EXPECT_EQ(request.has_id, false);
...
TEST(NANOPBTEST, test) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "0A0012050A0308E8071A0308890122220A200101010101010101010101"
        "0101010101010101010101010101010101010101012A220A2035548EC2"
        "9E9D85305850E87A2D2642FE7214FF4BB36334070DEAFC3345C3B127";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(NANOPBTEST, AddHotkey) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "0A02107B122322210A1F0A1D45717A3A0E68FCEEF546AC77BAC551754B"
        "48DBB1FCCFA180673030B602";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(NANOPBTEST, RemoveHotkey) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "0A02107B12232A210A1F0A1D45717A3A0E68FCEEF546AC77BAC551754B"
        "48DBB1FCCFA180673030B602";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(NANOPBTEST, Spawn) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "620310D20922210A1F0A1D1AE9690FA70DA5046B84210162105D0F6E51"
        "0B7211FA7B72AEED333702";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(NANOPBTEST, Disburse) {
    uint8_t inBuffer[1000];
    const char *tmp =
        "0A02107B1A2B0A05088092F40112220A2035548EC29E9D85305850E87A"
        "2D2642FE7214FF4BB36334070DEAFC3345C3B127";
    size_t len = parseHexString(inBuffer, sizeof(inBuffer), tmp);
    bool status;
...
TEST(CBORParserTest, TransactionSimpleEnvelope) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a46e696e67726573735f6578706972791b167886d92efc38"
        "8065706174687381824e726571756573745f7374617475735820564fd7aba0d5facd386a"
        "dad8c095339be3ad9222389decf64e0bddee3cc11e466c726571756573745f747970656a"
        "726561645f73746174656673656e646572581dbd28a51aa219af2443896127d178f9b2de"
        "34215c948f3e265a0e083d02";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, TokenTransfer) {
    ...
    uint8_t inBuffer[1000];
    const char *tmp =
        "d9d9f7a367636f6e74656e74a76c726571756573745f747970656463616c6c656e6f6e63"
        "6550f5390d960c6e52f489155a4309da03da6e696e67726573735f6578706972791b1674"
        "c5e29ec9c2106673656e646572581d19aa3d42c048dd7d14f0cfa0df69a1c1381780f6e9"
        "a137abaa6a82e3026b63616e69737465725f69644a000000000000000201016b6d657468"
        "6f645f6e616d656773656e645f70626361726758560a0012050a0308e8071a0308890122"
        "220a2001010101010101010101010101010101010101010101010101010101010101012a"
        "220a2035548ec29e9d85305850e87a2d2642fe7214ff4bb36334070deafc3345c3b1276d"
        "73656e6465725f7075626b657958583056301006072a8648ce3d020106052b8104000a03"
        "420004e1142e1fbc940344d9161709196bb8bd151f94379c48dd507ab99a0776109128b9"
        "4b5303cf2b2d28e25a779da175b62f8a975599b20c63d5193202640576ec5e6a73656e64"
        "65725f7369675840de5bccbb0a0173c432cd58ea4495d4d1e122d6ce04e31dcf63217f3d"
        "3a9b73130dc9bbf3b10e61c8db8bf8800bb4649e27786e5bc9418838c95864be28487a6"
        "a";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, IncreaseNeuronTimer) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a6636172675839620a10a7d18aaad3a2a2c6131a2b0a0508"
        "959aef3a12220a2068d518e2fd2be6566e62c36611b9794dfcbc04eb4227eefb73ab3c7a"
        "2d0ae5776b63616e69737465725f69644a000000000000000101016e696e67726573735f"
        "6578706972791b169bc8985c330d006b6d6574686f645f6e616d65706d616e6167655f6e"
        "6575726f6e5f70626c726571756573745f747970656463616c6c6673656e646572581d8a"
        "4aa4ffc7bc5ccdcd5a7a3d10c9bb06741063b02c7e908a624f721d02";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, StakeTx) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a663617267583e0a0a08f2d4a0eca697869f0812070a0508"
        "80c2d72f1a0308904e2a220a20a8a1abecdb66f57eb6eba44c3b5f11a6c433fe932680a9"
        "519b064b80ca8794e16b63616e69737465725f69644a000000000000000201016e696e67"
        "726573735f6578706972791b16985a582755f1806b6d6574686f645f6e616d656773656e"
        "645f70626c726571756573745f747970656463616c6c6673656e646572581d19aa3d42c0"
        "48dd7d14f0cfa0df69a1c1381780f6e9a137abaa6a82e302";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, ClaimNeuron) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a76c726571756573745f747970656463616c6c656e6f6e63"
        "65505833a6590c6d2b601e3a24557cfbb4336e696e67726573735f6578706972791b16ba"
        "d506bb4ca0f06673656e646572581d2594dccb73ca0226c58299d4e21badbcee00d153de"
        "ccb38fa20cd46e026b63616e69737465725f69644a000000000000000601016b6d657468"
        "6f645f6e616d656d636c61696d5f6e6575726f6e7363617267588b4449444c0001718201"
        "303431396230666563633566396131643531623930336432623632343464303565313261"
        "343866613862333537313965383132626236356439663930356133656139653561373233"
        "623635376166653931363132363964316631346331643830343765303232306164616334"
        "34653731313630323531656364616662613064636535";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, Configure_JoinCommunityFund) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a663617267486202107b12023a006b63616e69737465725f"
        "69644a000000000000000101016e696e67726573735f6578706972791b16ba67d2b864bf"
        "406b6d6574686f645f6e616d65706d616e6167655f6e6575726f6e5f70626c7265717565"
        "73745f747970656463616c6c6673656e646572581dd899978f029508f4fa5fce3d2539de"
        "5aade6d229efcc458233deee7502";
    auto inBufferLen = parseHexString(inBuffer, sizeof(inBuffer), tmp);
...
TEST(CBORParserTest, CombinedTX) {
    ...
    const char *tmp =
        "d9d9f7a167636f6e74656e74a46e696e67726573735f6578706972791b16bc685267142b"
        "8065706174687381824e726571756573745f737461747573582038b344ba26f15444b4f9"
        "89078c952ce99b559d3eb59e829c5a463a33812e32546c726571756573745f747970656a"
        "726561645f73746174656673656e646572581dd899978f029508f4fa5fce3d2539de5aad"
        "e6d229efcc458233deee7502";
    ...
    const char *tmp2 =
        "d9d9f7a167636f6e74656e74a66361726758320a0012050a0308904e1a0308904e2a220a"
        "20a2a794c66495083317e4be5197eb655b1e63015469d769e2338af3d3e3f3aa866b6361"
        "6e69737465725f69644a000000000000000201016e696e67726573735f6578706972791b"
        "16bc685084d14ec06b6d6574686f645f6e616d656773656e645f70626c72657175657374"
        "5f747970656463616c6c6673656e646572581dd899978f029508f4fa5fce3d2539de5aad"
        "e6d229efcc458233deee7502";
    ...
    //        uint32_t strLen = array_to_hexstr(array, sizeof(array), inBuffer,
    //        160); strLen += array_to_hexstr(array + strLen, sizeof(array) -
    //        strLen, inBuffer + 160, 200); EXPECT_EQ(strLen, 2*(156+192 + 8));
